	...
	return (
		<>
			...
			<div className="bg-analytikaBlack  py-4 flex flex-col items-center justify-center">
				...
				<div className="text-white flex rounded-md p-8 border-2 border-white text-xl mx-4 md:mx-16 max-w-full">
					...
					<div className="mx-16 flex-col items-center justify-center">
						<FaMapMarkerAlt
							...
							color="analytikaYellow"
						/>
						<div className="text-analytikaYellow">
							{event.venue}
						</div>
					</div>
				</div>
				<p className="text-white mt-8 mx-4 md:mx-16">
					{event.description}
				</p>
			</div>
		</>
